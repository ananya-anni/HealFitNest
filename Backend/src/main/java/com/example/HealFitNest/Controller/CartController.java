...
public class CartController {
    ...
    @PutMapping("/updateCartItem/{cartId}/{itemId}/{quantity}")
    public ResponseEntity<?> updateCartItem(@PathVariable String cartId, @PathVariable String itemId, @PathVariable int quantity){
